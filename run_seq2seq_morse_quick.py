...
def main():
    ...
    full_dataset = MorseDataset('morse_dataset.jsonl', tokenizer)
    # use a small subset for quick run
    n = min(200, len(full_dataset))
    ...
    metrics = evaluate_model(model, full_dataset, tokenizer, DEVICE, max_samples=100)
    print('Evaluation:', metrics)
    torch.save(model.state_dict(), 'model_morse_seq2seq_quick.pt')
